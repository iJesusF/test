...
function MainContent({ view }: { view: DashboardView }) {
  ...
  if (view === 'notes') return <PlaceholderView eyebrow="Notas" title="Notas de zonas" description="Las notas se editan desde el panel lateral de cada zona y se guardan en localStorage junto con el plano." />;
  if (view === 'files') return <PlaceholderView eyebrow="Archivos" title="Archivos locales del plano" description="Los planos subidos se almacenan temporalmente como Data URLs en localStorage. Para archivos remotos, conecta Supabase Storage." />;
