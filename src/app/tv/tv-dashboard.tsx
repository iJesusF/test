...
export function TvDashboard() {
  ...
  return <main className="min-h-screen bg-obsidian p-8 text-white">
    <div className="mb-6 flex items-center justify-between"><div><p className="text-sm uppercase tracking-[0.35em] text-muted">War room / kiosk</p><h1 className="text-4xl font-black">{project.name}</h1></div><div className="text-right text-muted">Auto refresh · 60s<br />TV 4K listo</div></div>
